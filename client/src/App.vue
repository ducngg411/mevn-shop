<template>
  <div id="iapp">
    ...
    <main class="container my-5">
      <flash-message :position="'top-right'"></flash-message>
...
.modal-content .btn-primary:hover {
  transform: translateY(-2px);
  box-shadow: 0 8px 15px -3px rgba(67, 97, 238, 0.5);
}
